...
# models/cpm_architecture/prototxt/caffemodel/manifold_diffarch3/to_test_tmp/pose_deploy_stg4.prototxt \
# models/cpm_architecture/prototxt/caffemodel/manifold_diffarch3/to_test_tmp/pose_iter_22000.caffemodel \
# --merge_parts_dir models/cpm_architecture/prototxt/caffemodel/manifold_diffarch3/to_test_tmp/ \
#        --num_parts 5 \
# python models/cpm_architecture/runCaffeTest.py \
# models/cpm_architecture/prototxt/caffemodel/manifold_diffarch3/to_test_tmp/pose_deploy_stg4.prototxt \
# models/cpm_architecture/prototxt/caffemodel/manifold_diffarch3/to_test_tmp/pose_iter_22000.caffemodel \
...
--json_file models/cpm_architecture/jsonDatasets/H36M_annotations_testSet_yasin.json
-o models/cpm_architecture/prototxt/caffemodel/manifold_diffarch3/to_test/yasin_pred/ \
